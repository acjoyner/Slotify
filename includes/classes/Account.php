<?php
    class Account{
        ...
        private function insertUserDetails($un, $fn, $ln, $em, $pw) {
            $encryptedPw = md5($pw); // Password -> long string of letters
            $profilePic = "/assets/images/profile-pics/profile-pic.jpg";
            $date = date("Y-m-d");
            // Add the user info into the datbase
        ...
        private function validateEmails($em,$em2){
            ...
            // TODO: Check that user name hasn't been used.
        ...
        private function validatePasswords($pw,$pw2){
            ...
            // Check for alph numeric characters
            if(preg_match('/[^A-Za-z0-9]/',$pw)){
                array_push($this->errorArray, Constants::$passwordsNotAlphanumberic);
                return;
            }
